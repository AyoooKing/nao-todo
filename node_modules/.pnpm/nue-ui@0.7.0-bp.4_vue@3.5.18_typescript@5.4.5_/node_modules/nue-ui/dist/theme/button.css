...
.nue-button {
    ...
    --icon-weight: var(--primary-font-weight);
}
...
.nue-button.nue-button--disabled {
...
.nue-button--primary {
    ...
    --hover-background-color: var(--primary-color-800);
    --active-background-color: var(--primary-color-800);
}
...
.nue-button--pure.nue-button--disabled {
    background-color: transparent;
}
/* Variables */
...
.nue-button-group > .nue-button {
    border-radius: 0;
    margin-left: -1px;
    box-shadow: none;
}

.nue-button-group > .nue-button:first-child {
    margin-left: 0;
...
.nue-button-group > .nue-button:last-child {
