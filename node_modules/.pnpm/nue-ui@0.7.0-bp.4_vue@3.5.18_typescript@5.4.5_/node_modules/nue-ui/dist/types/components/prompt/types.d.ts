import { InputPropsType, InputType, TextareaPropsType } from '../input';
import { Optional } from '@nue-ui/utils';
...
export type PromptBeforeConfirm = (value: unknown) => Promise<unknown> | boolean;
